...
export const createAdminValidationSchemaZod = z.object({
  body: z.object({
...
export const updateAdminValidationSchemaZod = z.object({
  body: z.object({
    admin: z.object({
...
export const AdminZodValidations = {
  createAdminValidationSchemaZod,
  updateAdminValidationSchemaZod,
};